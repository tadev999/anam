...
class ReleaseParticleEffect extends StatefulWidget {
  final bool isBurning;
  final VoidCallback onComplete;
  final Widget child;

  const ReleaseParticleEffect({
    super.key,
  ...
  @override
  State<ReleaseParticleEffect> createState() => _ReleaseParticleEffectState();
}

class _ReleaseParticleEffectState extends State<ReleaseParticleEffect>
  ...
  @override
  void didUpdateWidget(covariant ReleaseParticleEffect oldWidget) {
